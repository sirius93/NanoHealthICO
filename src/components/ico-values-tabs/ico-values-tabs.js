...
import verified2x from '../../assets/images/verified@2x.png';
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12">
              <h4 class="our-partners-heading">NHCT Ecosystem: Value Proposition</h4>
              ...
              <div className="mobile-only-container">
                <div className="values-content-container">
                    <h2 className="value-text-heading user">
                      Personalize Healthcare for an Individual by 
                    </h2>
                  <div className="col-xs-12 col-sm-4 col-md-4">
                    <div className="values-image-container">
                      <picture>
                    ...
                    <div className="values-text-container user">
                      <div className="col-xs-12">
                        <div className="col-xs-12 para">
                          ...
                          <p className="value-text-para">Incentivising users to be fit and healthy</p>
                        </div>
                        <div className="col-xs-12 para">
                          <span>
                            <picture>
                          ...
                          <p className="value-text-para">Focussing on their Total Health i.e. Mental Health, Physical Health, Diet and Fitness</p>
                        </div>
                        <div className="col-xs-12 para">
                          <span>
                            <picture>
                          ...
                          <p className="value-text-para">Giving AI based recommendations for preventive care</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="values-content-container">
                    <h2 className="value-text-heading service-provider">
                      Making health systems more effective and efficient by
                    </h2>
                        ...
                        <div className="values-text-container service-provider">
                          <div className="col-xs-12">
                            <div className="col-xs-12 para">
                              ...
                              <p className="value-text-para">Leveraging Health Coaches to drive continuous care</p>
                            </div>
                            <div className="col-xs-12 para">
                              <span>
                                <picture>
                              ...
                              <p className="value-text-para">Enabling safe and secure health data storage</p>
                            </div>
                            <div className="col-xs-12 para">
                              <span>
                                <picture>
                              ...
                              <p className="value-text-para">Creating verified data for personalized plans and research</p>
                            </div>
                          </div>
                        </div>
                    </div>
                ...
                {/*<Tabs defaultActiveKey={1} id="ico-values-tabs" className="hidden-xs">
                  ...
                  <Tabs defaultActiveKey={1} id="ico-values-tabs" className="hidden-xs">
                    <Tab tabClassName="user" eventKey={1} title="Personalize Healthcare for a user">
                      <div className="col-xs-12">
                        {/*<h2 className="value-text-heading">
                          Personalize Healthcare for an Individual by 
                        </h2>*/}
                            ...
                            <div className="values-text-container user">
                              <div className="col-xs-12">
                                ...
                                <div className="col-xs-12 para">
                                  ...
                                  <p className="value-text-para">Focussing on their Total Health</p>
                                </div>
                                <div className="col-xs-12 para">
                                  <span>
                                    <picture>
                    ...
                    <Tab tabClassName="service-provider" eventKey={2} title="Effective and Efficient Health Systems">
                      <div className="col-xs-12">
                          {/*<h2 className="value-text-heading">
                           Making health systems more effective and efficient by
                          </h2>*/}
                                ...
                                <div className="values-text-container service-provider">
                                  <div className="col-xs-12">
                                    ...
                                    <div className="col-xs-12 para">
                                      <span>
                                        <picture>
                                          <source media="(max-width: 767px)" srcset={ verified + ' 1x' + ',' + verified2x + ' 2x' } />
                                          <source media="(max-width: 1025px)" srcset={ verified + ' 1x' + ',' + verified2x + ' 2x' } />
                                          <source srcset={ verified + ' 1x' + ',' + verified2x + ' 2x' }  />
                                          <img width="10%" className="image-card-image" src={verified} alt="image2"/>
                                        </picture>
                                      </span>
                                      <p className="value-text-para">Creating verified data for personalized plans and research</p>
                                    </div>
