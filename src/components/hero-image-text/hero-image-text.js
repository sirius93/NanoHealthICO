...
/*
  handleClick = () => {
   var elmnt = document.getElementById("ico-summary");
   elmnt.scrollTop = -100;
  }*/
  handleClick(e) {
    /*e.preventDefault()*/
            ...
            <div className="col-xs-12">
              {/*<a href="/" className="Hero-image-text-logo"></a>
                  ...
                  header={
                    <div className="Header_root">
                      ...
                      <ul className="navbar-container Header_links">
                        ...
                        <span className="pipe-style">&nbsp;|&nbsp;</span>
                        <li className="Header_link"><a href="#nhct-ecosystem" className="Hero-image-text-navigator">NHCT Ecosystem</a></li>
                        <span className="pipe-style">&nbsp;|&nbsp;</span>
                        <li className="Header_link"><a href="#ico-summary" className="Hero-image-text-navigator" onClick={e => this.handleClick(e)}>ICO Summary</a></li>
                        <span className="pipe-style">&nbsp;|&nbsp;</span>
                ...
                <div className="col-xs-12 col-sm-6 col-md-6">  
                  ...
                  <h1 className="Hero-image-text-header">Blockchain powered ecosystem of Total Health</h1>
                  ...
                  <a href="mailto:ico@nanohealth.in?»&subject=Interested In Private Investment" className="Hero-image-text-investor">Interested in Private Sale <span className="glyphicon glyphicon-arrow-right"></span></a>
                </div>
