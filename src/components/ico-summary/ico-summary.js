          ...
          <div className="row">
            <div className="col-xs-12">
              <div className="ico-summary-container">
                ...
                <div className="col-xs-12 col-sm-4 col-md-4 ico-summary-token-name">
                  <h4> ERC 20 token</h4>
                ...
                <div className="col-xs-12 col-sm-6 col-md-6 ico-summary-token-circulation">
                  <h4>1,000,000,000</h4>
                  <p>No of Token in circulation</p>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-6 ico-summary-token-price">
                  <h4>$0.032</h4>
                  <p>BASE PRICE</p>
                </div>
              </div>
